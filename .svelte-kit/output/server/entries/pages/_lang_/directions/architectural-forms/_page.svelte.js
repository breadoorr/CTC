...
function ArchitecturalForms($$payload, $$props) {
  push();
  var $$store_subs;
  const images = [
    {
  ...
  $$payload.out.push(`<section class="page-header svelte-11kokgt"><div class="container"><h1 class="svelte-11kokgt">${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "Small Architectural Structures" : "Малые архитектурные формы")}</h1></div></section> <section class="section"><div class="container"><div class="direction-intro svelte-11kokgt"><p class="svelte-11kokgt">${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "We design and build beautiful, functional small architectural structures that enhance your outdoor space. From gazebos and pergolas to guest houses and garden pavilions, our structures are built to last and designed to impress." : "Мы проектируем и строим красивые, функциональные малые архитектурные формы, которые улучшают ваше открытое пространство. От беседок и пергол до гостевых домиков и садовых павильонов, наши конструкции созданы на долгие годы и разработаны, чтобы впечатлять.")}</p></div> <div class="direction-features svelte-11kokgt"><div class="feature svelte-11kokgt"><div class="feature-icon svelte-11kokgt"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 3L1 9L5 11.18V17.18L12 21L19 17.18V11.18L21 10.09V17H23V9L12 3ZM18.82 9L12 12.72L5.18 9L12 5.28L18.82 9ZM17 15.99L12 18.72L7 15.99V12.27L12 15L17 12.27V15.99Z" fill="currentColor"></path></svg></div> <div class="feature-content svelte-11kokgt"><h3 class="svelte-11kokgt">${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "Custom Design" : "Индивидуальный дизайн")}</h3> <p class="svelte-11kokgt">${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "We create structures tailored to your specific needs and preferences." : "Мы создаем конструкции, адаптированные к вашим конкретным потребностям и предпочтениям.")}</p></div></div> <div class="feature svelte-11kokgt"><div class="feature-icon svelte-11kokgt"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 21.35L10.55 20.03C5.4 15.36 2 12.28 2 8.5C2 5.42 4.42 3 7.5 3C9.24 3 10.91 3.81 12 5.09C13.09 3.81 14.76 3 16.5 3C19.58 3 22 5.42 22 8.5C22 12.28 18.6 15.36 13.45 20.04L12 21.35Z" fill="currentColor"></path></svg></div> <div class="feature-content svelte-11kokgt"><h3 class="svelte-11kokgt">${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "Quality Materials" : "Качественные материалы")}</h3> <p class="svelte-11kokgt">${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "We use only the finest wood and hardware for our structures." : "Мы используем только лучшую древесину и фурнитуру для наших конструкций.")}</p></div></div> <div class="feature svelte-11kokgt"><div class="feature-icon svelte-11kokgt"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM9 17H7V10H9V17ZM13 17H11V7H13V17ZM17 17H15V13H17V17Z" fill="currentColor"></path></svg></div> <div class="feature-content svelte-11kokgt"><h3 class="svelte-11kokgt">${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "Functionality" : "Функциональность")}</h3> <p class="svelte-11kokgt">${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "Our structures combine aesthetics with practical functionality." : "Наши конструкции сочетают эстетику с практической функциональностью.")}</p></div></div></div> <h2>${escape_html(store_get($$store_subs ??= {}, "$currentLang", currentLang) === "en" ? "Our Projects" : "Наши проекты")}</h2> <div class="gallery-grid svelte-11kokgt"><!--[-->`);
