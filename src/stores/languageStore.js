...
const translations = {
  en: {
    ...
    privateHomes: 'Interior and Exterior Decor',
    ...
    privateHomesService: 'Interior and Exterior Decor',
    ...
    privateHomesCategory: 'Interior and Exterior Decor',
  ...
  ru: {
    ...
    privateHomes: 'Внутренний и внешний декор',
    ...
    privateHomesService: 'Внутренний и внешний декор',
    privateHomesDesc: 'Проектирование по вашему индивидуальному плану и спецификациям.',
    ...
    privateHomesCategory: 'Внутренний и внешний декор',
    ...
    // Contact page
    contactPageIntro: 'Мы всегда рады обратной связи! Не стесняйтесь обращаться к нам с любыми вопросами или запросами.',
    phone: 'Телефон',
